...
public class Robot {
    ...
    private void moveTowards(int destination) {
        if (current_floor < destination) {
            ...
            if (current_floor <= deliveryItem.getDestFloor()) {
                deliveryItem.addActivity(new MovementActivity(true));
            }

            if (tube != null && current_floor <= tube.getDestFloor()) {
                tube.addActivity(new MovementActivity(true));
            }
        } else {
            current_floor--;

            if (deliveryItem != null) {
                deliveryItem.addActivity(new MovementActivity(false));
            }
        }
    }
